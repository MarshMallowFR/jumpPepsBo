...
//   label: string;
//   options: { name: string; id: string }[];
//   onSelect: (value: string | null) => void; // Permettre la sélection de null
//   color?: Color;
// }
...
//   const handleOptionClick = (value: string | null, label: string) => {
//     setSelectedOption(label);
//     onSelect(value);
//     setIsOpen(false);
//   };
...
//         <div className="origin-top-left absolute left-0 mt-2 w-56 rounded-md shadow-custom-shadow bg-white z-50">
//           <div className="py-1">
//             {/* Option par défaut pour réinitialiser */}
//             <button
//               onClick={() =>
//                 handleOptionClick(null, 'Aucune saison sélectionnée')
//               }
//               className={`block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left ${colorClass.option}`}
//             >
